package dev.razorni.core.extras.namemc.request;
...
public class Request {
    ...
    public boolean hasLiked() {
        boolean value = false;
        try {
            URL requestHTTP = new URL("https://api.namemc.com/server/" + Core.getInstance().getConfig().getString("NAMEMC.SERVER-IP") + "/likes?profile=" + uuid.toString());
