...
public class TempRanksMenu extends Menu {

    @Override
    public String getTitle(Player player) {
        return CC.translate("&eTemp Ranks Shop &7┃ &e⛁ " + Profile.getByUuid(player.getUniqueId()).getCoins());
    }
    ...
    public static class ApprenticeButton extends Button {
        ...
        public void clicked(Player player, ClickType clickType) {
            ...
            Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "setrank " + player.getName() + " Apprentice 14d Bought");
    ...
    public static class RogueButton extends Button {
        ...
        public void clicked(Player player, ClickType clickType) {
            ...
            Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "setrank " + player.getName() + " Rogue 14d Bought");
    ...
    public static class SentinelButton extends Button {
        ...
        public void clicked(Player player, ClickType clickType) {
            ...
            Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "setrank " + player.getName() + " Sentinel 14d Bought");
    ...
    public static class ProphetButton extends Button {
        ...
        public void clicked(Player player, ClickType clickType) {
            ...
            Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "setrank " + player.getName() + " Prophet 14d Bought");
    ...
    public static class ChancellorButton extends Button {
        ...
        public void clicked(Player player, ClickType clickType) {
            ...
            Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "setrank " + player.getName() + " Chancellor 14d Bought");
    ...
    public static class ImmortalButton extends Button {
        ...
        public void clicked(Player player, ClickType clickType) {
            ...
            Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "setrank " + player.getName() + " Immortal 14d Bought");
