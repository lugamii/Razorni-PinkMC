...
public class UnmuteCommand {
	...
	@Command(names = "unmute", permission = "gravity.command.unmute", async = true)
	public static void unmute(CommandSender sender, @Param(name = "target") UUID target, @Param(name = "reason", wildcard = true) String reason) {
