package dev.razorni.core.util.uuid;

import com.google.common.base.Preconditions;
import dev.razorni.core.Core;
import dev.razorni.core.util.uuid.impl.BukkitUUIDCache;
...
public final class UniqueIDCache {
    ...
    public static void init() {
        ...
        Core.getInstance().getServer().getPluginManager().registerEvents(new UUIDListener(), Core.getInstance());
    }
