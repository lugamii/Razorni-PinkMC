package dev.razorni.hcfactions.utils.trash.menu;

import dev.razorni.hcfactions.HCF;
import dev.razorni.hcfactions.utils.trash.ChatUtil;
...
public abstract class Menu {
    ...
    public void openMenu(final Player player) {
        ...
        if (autoUpdate && task == null) {
            task = HCF.getPlugin().getServer().getScheduler().runTaskTimer(HCF.getPlugin(), () -> this.openMenu(player), 0, 20L);
        }
    }
