...
public class BlockBanner extends BlockContainer {
    ...
    public void a(World world, EntityHuman entityhuman, BlockPosition blockposition, IBlockData iblockdata, TileEntity tileentity) {
        if (tileentity instanceof TileEntityBanner) {
            ...
            super.a(world, entityhuman, blockposition, iblockdata, null);
        }
    ...
    public static class BlockStandingBanner extends BlockBanner {
        ...
        public BlockStandingBanner() {
            this.j(this.blockStateList.getBlockData().set(BlockBanner.BlockStandingBanner.ROTATION, 0));
        }
        ...
        public IBlockData fromLegacyData(int i) {
            return this.getBlockData().set(BlockBanner.BlockStandingBanner.ROTATION, i);
        }

        public int toLegacyData(IBlockData iblockdata) {
            return iblockdata.get(BlockStandingBanner.ROTATION);
        }

        protected BlockStateList getStateList() {
            return new BlockStateList(this, BlockStandingBanner.ROTATION);
        }
    }
    ...
    public static class BlockWallBanner extends BlockBanner {
        ...
        public void updateShape(IBlockAccess iblockaccess, BlockPosition blockposition) {
            EnumDirection enumdirection = iblockaccess.getType(blockposition).get(BlockWallBanner.FACING);
            float f = 0.0F;
            float f1 = 0.78125F;
            float f2 = 0.0F;
            float f3 = 1.0F;
        ...
        public void doPhysics(World world, BlockPosition blockposition, IBlockData iblockdata, Block block) {
            EnumDirection enumdirection = iblockdata.get(BlockWallBanner.FACING);
        ...
        public int toLegacyData(IBlockData iblockdata) {
            return iblockdata.get(BlockWallBanner.FACING).a();
        }

        protected BlockStateList getStateList() {
            return new BlockStateList(this, BlockWallBanner.FACING);
        }
    }
}
