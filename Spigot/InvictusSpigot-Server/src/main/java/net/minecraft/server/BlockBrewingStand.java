...
public class BlockBrewingStand extends BlockContainer {
    ...
    public BlockBrewingStand() {
        super(Material.ORE);
        this.j(this.blockStateList.getBlockData().set(BlockBrewingStand.HAS_BOTTLE[0], false).set(BlockBrewingStand.HAS_BOTTLE[1], Boolean.FALSE).set(BlockBrewingStand.HAS_BOTTLE[2], false));
    }
