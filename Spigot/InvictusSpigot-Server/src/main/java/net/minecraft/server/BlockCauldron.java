...
public class BlockCauldron extends Block {
    ...
    public void a(World world, BlockPosition blockposition, IBlockData iblockdata, AxisAlignedBB axisalignedbb, List<AxisAlignedBB> list, Entity entity) {
        ...
        super.a(world, blockposition, iblockdata, axisalignedbb, list, entity);
        this.a(1.0F - 0.125F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
        super.a(world, blockposition, iblockdata, axisalignedbb, list, entity);
        this.a(0.0F, 0.0F, 1.0F - 0.125F, 1.0F, 1.0F, 1.0F);
        super.a(world, blockposition, iblockdata, axisalignedbb, list, entity);
        this.j();
    }
    ...
    public void a(World world, BlockPosition blockposition, IBlockData iblockdata, Entity entity) {
        ...
        if (entity.isBurning() && i > 0 && entity.getBoundingBox().b <= (double) f) {
            entity.extinguish();
    ...
    public void a(World world, BlockPosition blockposition, IBlockData iblockdata, int i) {
        world.setTypeAndData(blockposition, iblockdata.set(BlockCauldron.LEVEL, MathHelper.clamp(i, 0, 3)), 2);
    ...
    public int l(World world, BlockPosition blockposition) {
        return world.getType(blockposition).get(BlockCauldron.LEVEL);
    }
