...
public class BlockCobbleWall extends Block {
    ...
    public BlockCobbleWall(Block block) {
        ...
        this.j(this.blockStateList.getBlockData().set(BlockCobbleWall.UP, Boolean.FALSE).set(BlockCobbleWall.NORTH, Boolean.FALSE).set(BlockCobbleWall.EAST, Boolean.FALSE).set(BlockCobbleWall.SOUTH, Boolean.FALSE).set(BlockCobbleWall.WEST, Boolean.FALSE).set(BlockCobbleWall.VARIANT, BlockCobbleWall.EnumCobbleVariant.NORMAL));
    ...
    public boolean e(IBlockAccess iblockaccess, BlockPosition blockposition) {
        ...
        return block != Blocks.BARRIER && (block == this || block instanceof BlockFenceGate || (block.material.k() && block.d() && block.material != Material.PUMPKIN));
    }
    ...
    public IBlockData updateState(IBlockData iblockdata, IBlockAccess iblockaccess, BlockPosition blockposition) {
        return iblockdata.set(BlockCobbleWall.UP, !iblockaccess.isEmpty(blockposition.up())).set(BlockCobbleWall.NORTH, this.e(iblockaccess, blockposition.north())).set(BlockCobbleWall.EAST, this.e(iblockaccess, blockposition.east())).set(BlockCobbleWall.SOUTH, this.e(iblockaccess, blockposition.south())).set(BlockCobbleWall.WEST, this.e(iblockaccess, blockposition.west()));
    }

    protected BlockStateList getStateList() {
        return new BlockStateList(this, BlockCobbleWall.UP, BlockCobbleWall.NORTH, BlockCobbleWall.EAST, BlockCobbleWall.WEST, BlockCobbleWall.SOUTH, BlockCobbleWall.VARIANT);
    }
    ...
    public static enum EnumCobbleVariant implements INamable {
        ...
        static {
            for (EnumCobbleVariant blockcobblewall_enumcobblevariant : values()) {
                EnumCobbleVariant.c[blockcobblewall_enumcobblevariant.a()] = blockcobblewall_enumcobblevariant;
            }
