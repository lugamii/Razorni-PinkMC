...
public class BlockDirt extends Block {
    ...
    protected BlockDirt() {
        ...
        this.j(this.blockStateList.getBlockData().set(BlockDirt.VARIANT, BlockDirt.EnumDirtVariant.DIRT).set(BlockDirt.SNOWY, Boolean.FALSE));
    ...
    public IBlockData updateState(IBlockData iblockdata, IBlockAccess iblockaccess, BlockPosition blockposition) {
        if (iblockdata.get(BlockDirt.VARIANT) == BlockDirt.EnumDirtVariant.PODZOL) {
            ...
            iblockdata = iblockdata.set(BlockDirt.SNOWY, block == Blocks.SNOW || block == Blocks.SNOW_LAYER);
        }
    ...
    public static enum EnumDirtVariant implements INamable {
        ...
        static {
            for (EnumDirtVariant blockdirt_enumdirtvariant : values()) {
