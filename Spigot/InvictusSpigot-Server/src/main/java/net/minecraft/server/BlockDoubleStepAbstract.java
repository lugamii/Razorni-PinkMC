...
public abstract class BlockDoubleStepAbstract extends BlockStepAbstract {
    ...
    public BlockDoubleStepAbstract() {
        ...
        if (this.l()) {
            iblockdata = iblockdata.set(BlockDoubleStepAbstract.SEAMLESS, Boolean.FALSE);
        } else {
    ...
    public IBlockData fromLegacyData(int i) {
        ...
        if (this.l()) {
            iblockdata = iblockdata.set(BlockDoubleStepAbstract.SEAMLESS, (i & 8) != 0);
        } else {
    ...
    public int toLegacyData(IBlockData iblockdata) {
        ...
        if (this.l()) {
            if (iblockdata.get(BlockDoubleStepAbstract.SEAMLESS)) {
                i |= 8;
            }
    ...
    public static enum EnumStoneSlabVariant implements INamable {
        ...
        static {
            for (EnumStoneSlabVariant blockdoublestepabstract_enumstoneslabvariant : values()) {
