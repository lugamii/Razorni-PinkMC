...
public abstract class BlockDoubleStoneStepAbstract extends BlockStepAbstract {
    ...
    public BlockDoubleStoneStepAbstract() {
        ...
        if (this.l()) {
            iblockdata = iblockdata.set(BlockDoubleStoneStepAbstract.SEAMLESS, Boolean.FALSE);
        } else {
    ...
    public IBlockData fromLegacyData(int i) {
        ...
        if (this.l()) {
            iblockdata = iblockdata.set(BlockDoubleStoneStepAbstract.SEAMLESS, (i & 8) != 0);
        } else {
    ...
    public int toLegacyData(IBlockData iblockdata) {
        ...
        if (this.l()) {
            if (iblockdata.get(BlockDoubleStoneStepAbstract.SEAMLESS)) {
                i |= 8;
            }
    ...
    public static enum EnumStoneSlab2Variant implements INamable {
        ...
        static {
            for (EnumStoneSlab2Variant blockdoublestonestepabstract_enumstoneslab2variant : values()) {
