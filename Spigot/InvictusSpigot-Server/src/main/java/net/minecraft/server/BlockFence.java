...
public class BlockFence extends Block {
    ...
    public BlockFence(Material material, MaterialMapColor materialmapcolor) {
        ...
        this.j(this.blockStateList.getBlockData().set(BlockFence.NORTH, Boolean.FALSE).set(BlockFence.EAST, Boolean.FALSE).set(BlockFence.SOUTH, Boolean.FALSE).set(BlockFence.WEST, Boolean.FALSE));
    ...
    public IBlockData updateState(IBlockData iblockdata, IBlockAccess iblockaccess, BlockPosition blockposition) {
        return iblockdata.set(BlockFence.NORTH, this.e(iblockaccess, blockposition.north())).set(BlockFence.EAST, this.e(iblockaccess, blockposition.east())).set(BlockFence.SOUTH, this.e(iblockaccess, blockposition.south())).set(BlockFence.WEST, this.e(iblockaccess, blockposition.west()));
    }
