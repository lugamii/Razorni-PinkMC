...
public abstract class BlockFlowers extends BlockPlant {
    ...
    public IBlockState<BlockFlowers.EnumFlowerVarient> n() {
        if (this.TYPE == null) {
            this.TYPE = BlockStateEnum.a("type", BlockFlowers.EnumFlowerVarient.class, blockflowers_enumflowervarient -> blockflowers_enumflowervarient.a() == BlockFlowers.this.l());
        }
