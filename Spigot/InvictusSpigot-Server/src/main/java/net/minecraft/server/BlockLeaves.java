...
public abstract class BlockLeaves extends BlockTransparent {
    ...
    public void remove(World world, BlockPosition blockposition, IBlockData iblockdata) {
        ...
        if (InvictusConfig.decayLeaf && world.areChunksLoadedBetween(j - i, k - i, l - i, j + i, k + i, l + i)) {
    ...
    public void b(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
        if (InvictusConfig.decayLeaf && iblockdata.get(BlockLeaves.CHECK_DECAY) && iblockdata.get(BlockLeaves.DECAYABLE)) {
            byte b0 = 4;
            int i = b0 + 1;
            int j = blockposition.getX();
            int k = blockposition.getY();
            ...
            if (world.areChunksLoadedBetween(j - i, k - i, l - i, j + i, k + i, l + i)) {
                int k1;
                int l1;
                int i2;
                ...
                for (k1 = -b0; k1 <= b0; ++k1) {
                    for (l1 = -b0; l1 <= b0; ++l1) {
                        for (i2 = -b0; i2 <= b0; ++i2) {
                            Block block = world.getType(j + k1, k + l1, l + i2).getBlock();
    ...
    public void dropNaturally(World world, BlockPosition blockposition, IBlockData iblockdata, float f, int i) {
        ...
        if (world.random.nextInt(j) == 0) {
            a(world, blockposition, new ItemStack(getDropType(iblockdata, world.random, i), 1, this.getDropData(iblockdata)));
        }
