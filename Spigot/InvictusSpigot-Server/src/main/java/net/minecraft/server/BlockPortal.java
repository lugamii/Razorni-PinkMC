...
public class BlockPortal extends BlockHalfTransparent {
    ...
    public void b(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
        ...
        if (world.spigotConfig.enableZombiePigmenPortalSpawns && world.worldProvider.d() && world.getGameRules().getBoolean("doMobSpawning") && random.nextInt(2000) < world.getDifficulty().a()) { // Spigot
            ...
            if (i > 0 && !world.getType(blockposition1.getX(), blockposition1.getY() + 1, blockposition1.getZ()).getBlock().isOccluding()) {
    ...
    public static class Shape {
        ...
        protected int a(BlockPosition blockposition, EnumDirection enumdirection) {
            ...
            for (i = 0; i < 22; ++i) {
                ...
                if (!this.a(this.a.getType(blockposition1).getBlock()) || this.a.getType(blockposition1.getX(), blockposition1.getY() - 1, blockposition1.getZ()).getBlock() != Blocks.OBSIDIAN) {
                    break;
                }
            }
