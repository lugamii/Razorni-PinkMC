...
public class BlockPumpkin extends BlockDirectional {
    ...
    private void f(World world, BlockPosition blockposition) {
        ...
        if ((shapedetector_shapedetectorcollection = this.getDetectorSnowGolem().a(world, blockposition)) != null) {
            ...
            for (j = 0; j < 120; ++j) {
                world.addParticle(EnumParticle.SNOW_SHOVEL, (double) blockposition1.getX() + world.random.nextDouble(), (double) blockposition1.getY() + world.random.nextDouble() * 2.5D, (double) blockposition1.getZ() + world.random.nextDouble(), 0.0D, 0.0D, 0.0D, EnumParticle.EMPTY_ARRAY);
            }
            ...
            for (j = 0; j < 120; ++j) {
                world.addParticle(EnumParticle.SNOWBALL, blockposition2.getX() + world.random.nextDouble(), blockposition2.getY() + world.random.nextDouble() * 3.9D, blockposition2.getZ() + world.random.nextDouble(), 0.0D, 0.0D, 0.0D, EnumParticle.EMPTY_ARRAY);
            }
    ...
    public boolean canPlace(World world, BlockPosition blockposition) {
        return world.getType(blockposition).getBlock().material.isReplaceable() && World.a(world, blockposition.getX(), blockposition.getY() - 1, blockposition.getZ());
    }
