...
public class BlockRedstoneComparator extends BlockDiodeAbstract implements IContainer {
    ...
    public BlockRedstoneComparator(boolean flag) {
        super(flag);
        this.j(this.blockStateList.getBlockData().set(BlockRedstoneComparator.FACING, EnumDirection.NORTH).set(BlockRedstoneComparator.POWERED, Boolean.FALSE).set(BlockRedstoneComparator.MODE, BlockRedstoneComparator.EnumComparatorMode.COMPARE));
    ...
    protected boolean l(IBlockData iblockdata) {
        return this.N || iblockdata.get(BlockRedstoneComparator.POWERED);
    }
    ...
    private int j(World world, BlockPosition blockposition, IBlockData iblockdata) {
        return iblockdata.get(BlockRedstoneComparator.MODE) == BlockRedstoneComparator.EnumComparatorMode.SUBTRACT ?
                Math.max(this.f(world, blockposition, iblockdata) - this.c(world, blockposition, iblockdata), 0) : this.f(world, blockposition, iblockdata);
    }
    ...
    private EntityItemFrame a(World world, final EnumDirection enumdirection, BlockPosition blockposition) {
        List<EntityItemFrame> list = world.a(EntityItemFrame.class, new AxisAlignedBB(blockposition.getX(), blockposition.getY(), blockposition.getZ(), blockposition.getX() + 1, (blockposition.getY() + 1), (blockposition.getZ() + 1)), (Predicate<Entity>) entity -> entity != null && entity.getDirection() == enumdirection);
    ...
    protected void g(World world, Chunk chunk, BlockPosition blockposition, IBlockData iblockdata) {
        if (!world.a(blockposition, this)) {
            int i = this.j(world, blockposition, iblockdata);
            TileEntity tileentity = world.getTileEntity(chunk, blockposition);
            int j = tileentity instanceof TileEntityComparator ? ((TileEntityComparator) tileentity).b() : 0;

            if (i != j || this.l(iblockdata) != this.e(world, blockposition, iblockdata)) {
                if (this.i(world, blockposition, iblockdata)) {
                    world.a(blockposition, chunk, this, 2, -1);
                } else {
                    world.a(blockposition, chunk, this, 2, 0);
                }
            }
    ...
    private void k(World world, Chunk chunk, BlockPosition blockposition, IBlockData iblockdata) {
        int i = this.j(world, blockposition, iblockdata);
        TileEntity tileentity = world.getTileEntity(chunk, blockposition);
        int j = 0;
        ...
        if (j != i || iblockdata.get(BlockRedstoneComparator.MODE) == BlockRedstoneComparator.EnumComparatorMode.COMPARE) {
            ...
            if (flag1 && !flag) {
                world.setTypeAndDataWithChunk(chunk, blockposition, iblockdata.set(BlockRedstoneComparator.POWERED, false), 2, false, false);
            } else if (!flag1 && flag) {
                world.setTypeAndDataWithChunk(chunk, blockposition, iblockdata.set(BlockRedstoneComparator.POWERED, true), 2, false, false);
            }
    ...
    public void b(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
        if (this.N) {
            world.setTypeAndData(blockposition, this.k(iblockdata).set(BlockRedstoneComparator.POWERED, true), 4);
        }
    ...
    public void b(World world, Chunk chunk, BlockPosition blockposition, IBlockData iblockdata, Random random) {
        if (this.N) {
            world.setTypeAndDataWithChunk(chunk, blockposition, this.k(iblockdata).set(BlockRedstoneComparator.POWERED, true), 4, false, false);
        }

        this.k(world, chunk, blockposition, iblockdata);
    }
    ...
    public IBlockData fromLegacyData(int i) {
        return this.getBlockData().set(BlockRedstoneComparator.FACING, EnumDirection.fromType2(i)).set(BlockRedstoneComparator.POWERED, (i & 8) > 0).set(BlockRedstoneComparator.MODE, (i & 4) > 0 ? BlockRedstoneComparator.EnumComparatorMode.SUBTRACT : BlockRedstoneComparator.EnumComparatorMode.COMPARE);
    }

    public int toLegacyData(IBlockData iblockdata) {
        byte b0 = 0;
        int i = b0 | iblockdata.get(BlockRedstoneComparator.FACING).b();

        if (iblockdata.get(BlockRedstoneComparator.POWERED)) {
            i |= 8;
        }
    ...
    public IBlockData getPlacedState(World world, BlockPosition blockposition, EnumDirection enumdirection, float f, float f1, float f2, int i, EntityLiving entityliving) {
        return this.getBlockData().set(BlockRedstoneComparator.FACING, entityliving.getDirection().opposite()).set(BlockRedstoneComparator.POWERED, Boolean.FALSE).set(BlockRedstoneComparator.MODE, BlockRedstoneComparator.EnumComparatorMode.COMPARE);
    }
