...
public class BlockReed extends Block {
    ...
    public void b(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
        if ((world.getType(blockposition.getX(), blockposition.getY() - 1, blockposition.getZ()).getBlock() == Blocks.REEDS || (InvictusConfig.dropFloatingPlants && e(world, blockposition, iblockdata))) && world.isEmpty(blockposition.getX(), blockposition.getY() - 1, blockposition.getZ())) {
            int i;
