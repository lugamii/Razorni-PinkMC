...
public class BlockSapling extends BlockPlant implements IBlockFragilePlantElement {
    ...
    public void b(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
        ...
        if (world.getLightLevel(blockposition.getX(), blockposition.getY() + 1, blockposition.getZ()) >= 9 && (random.nextInt(Math.max(2, (int) ((world.growthOdds / world.spigotConfig.saplingModifier * 7) + 0.5F))) == 0)) { // Spigot) {
            // CraftBukkit start
