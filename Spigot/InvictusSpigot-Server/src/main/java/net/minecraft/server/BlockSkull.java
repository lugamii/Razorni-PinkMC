...
public class BlockSkull extends BlockContainer {
    ...
    public boolean b(World world, BlockPosition blockposition, ItemStack itemstack) {
        return itemstack.getData() == 1 && blockposition.getY() >= 2 && world.getDifficulty() != EnumDifficulty.PEACEFUL && this.l().a(world, blockposition) != null;
    }
        ...
        if (tileentityskull.getSkullType() == 1 && blockposition.getY() >= 2 && world.getDifficulty() != EnumDifficulty.PEACEFUL) {
            ...
            if (shapedetector_shapedetectorcollection != null) {
                ...
                if (world.addEntity(entitywither, SpawnReason.BUILD_WITHER)) {
                    ...
                    for (k = 0; k < 120; ++k) {
                        world.addParticle(EnumParticle.SNOWBALL, blockposition1.getX() + world.random.nextDouble(),  (blockposition1.getY() - 2) + world.random.nextDouble() * 3.9D, blockposition1.getZ() + world.random.nextDouble(), 0.0D, 0.0D, 0.0D, EnumParticle.EMPTY_ARRAY);
                    }
