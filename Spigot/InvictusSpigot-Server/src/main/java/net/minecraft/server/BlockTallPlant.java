...
public class BlockTallPlant extends BlockPlant implements IBlockFragilePlantElement {
    ...
    public boolean canPlace(World world, BlockPosition blockposition) {
        return super.canPlace(world, blockposition) && world.isEmpty(blockposition.getX(), blockposition.getY() + 1, blockposition.getZ());
    }
    ...
    public boolean a(World world, BlockPosition blockposition) {
        ...
        if (iblockdata.getBlock() != this) {
            ...
            BlockTallPlant.EnumTallFlowerVariants blocktallplant_enumtallflowervariants = this.updateState(iblockdata, world, blockposition).get(BlockTallPlant.VARIANT);
    ...
    public void a(World world, EntityHuman entityhuman, BlockPosition blockposition, IBlockData iblockdata, TileEntity tileentity) {
        if (entityhuman.bZ() == null || entityhuman.bZ().getItem() != Items.SHEARS || iblockdata.get(BlockTallPlant.HALF) != BlockTallPlant.EnumTallPlantHalf.LOWER || !this.b(world, blockposition, iblockdata, entityhuman)) {
    ...
    public int toLegacyData(IBlockData iblockdata) {
        return iblockdata.get(BlockTallPlant.HALF) == BlockTallPlant.EnumTallPlantHalf.UPPER ? 8 | iblockdata.get(BlockTallPlant.N).b() : iblockdata.get(BlockTallPlant.VARIANT).a();
    }

    protected BlockStateList getStateList() {
        return new BlockStateList(this, BlockTallPlant.HALF, BlockTallPlant.VARIANT, BlockTallPlant.N);
    }
