...
public class BlockThin extends Block {
    ...
    protected BlockThin(Material material, boolean flag) {
        super(material);
        this.j(this.blockStateList.getBlockData().set(BlockThin.NORTH, false).set(BlockThin.EAST, false).set(BlockThin.SOUTH, false).set(BlockThin.WEST, false));
        this.a = flag;
        this.a(CreativeModeTab.c);
    }

    public IBlockData updateState(IBlockData iblockdata, IBlockAccess iblockaccess, BlockPosition blockposition) {
        return iblockdata.set(BlockThin.NORTH, this.c(iblockaccess.getType(blockposition.north()).getBlock())).set(BlockThin.SOUTH, this.c(iblockaccess.getType(blockposition.south()).getBlock())).set(BlockThin.WEST, this.c(iblockaccess.getType(blockposition.west()).getBlock())).set(BlockThin.EAST, this.c(iblockaccess.getType(blockposition.east()).getBlock()));
    }
    ...
    public final boolean c(Block block) {
        return block.o() || block == Blocks.GLASS || block == Blocks.STAINED_GLASS || block == Blocks.STAINED_GLASS_PANE || block instanceof BlockThin;
    }
    ...
    protected BlockStateList getStateList() {
        return new BlockStateList(this, BlockThin.NORTH, BlockThin.EAST, BlockThin.WEST, BlockThin.SOUTH);
    }
}
