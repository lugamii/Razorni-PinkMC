...
public class BlockTripwireHook extends Block {
    ...
    public IBlockData updateState(IBlockData iblockdata, IBlockAccess iblockaccess, BlockPosition blockposition) {
        return iblockdata.set(BlockTripwireHook.SUSPENDED, !World.a(iblockaccess, blockposition.getX(), blockposition.getY() - 1, blockposition.getZ()));
    }
    ...
    public IBlockData getPlacedState(World world, BlockPosition blockposition, EnumDirection enumdirection, float f, float f1, float f2, int i, EntityLiving entityliving) {
        IBlockData iblockdata = this.getBlockData().set(BlockTripwireHook.POWERED, false).set(BlockTripwireHook.ATTACHED, false).set(BlockTripwireHook.SUSPENDED, Boolean.FALSE);
    ...
    public void a(World world, BlockPosition blockposition, IBlockData iblockdata, boolean flag, boolean flag1, int i, IBlockData iblockdata1) {
        ...
        boolean flag4 = !World.a(world, blockposition.getX(), blockposition.getY() - 1, blockposition.getZ());
        boolean flag5 = !flag;
        boolean flag6 = false;
        int j = 0;
