...
public class ChunkProviderGenerate implements IChunkProvider {
    ...
    public void getChunkAt(IChunkProvider ichunkprovider, int i, int j) {
        ...
        BiomeBase biomebase = this.m.getBiome(k + 16, 0, l + 16);
        ...
        if (m.generatorConfig.genWaterLakes && biomebase != BiomeBase.DESERT && biomebase != BiomeBase.DESERT_HILLS && this.r.A && !flag && this.h.nextInt(this.r.B) == 0) {
        ...
        if (m.generatorConfig.genLavaLakes && !flag && this.h.nextInt(this.r.D / 10) == 0 && this.r.C) {
            k1 = this.h.nextInt(16) + 8;
