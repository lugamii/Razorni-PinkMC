...
public class ChunkProviderTheEnd implements IChunkProvider {
        ...
        for (int i1 = 0; i1 < b0; ++i1) {
            for (int j1 = 0; j1 < b0; ++j1) {
                for (int k1 = 0; k1 < 32; ++k1) {
                    double d0 = 0.25D;
                    double d1 = this.m[((i1) * l + j1) * b1 + k1];
                    double d2 = this.m[((i1) * l + j1 + 1) * b1 + k1];
                    double d3 = this.m[((i1 + 1) * l + j1) * b1 + k1];
                    double d4 = this.m[((i1 + 1) * l + j1 + 1) * b1 + k1];
                    double d5 = (this.m[((i1) * l + j1) * b1 + k1 + 1] - d1) * d0;
                    double d6 = (this.m[((i1) * l + j1 + 1) * b1 + k1 + 1] - d2) * d0;
                    double d7 = (this.m[((i1 + 1) * l + j1) * b1 + k1 + 1] - d3) * d0;
    ...
    public void getChunkAt(IChunkProvider ichunkprovider, int i, int j) {
        ...
        this.l.getBiome(blockposition.getX() + 16, 0, blockposition.getZ() + 16).a(this.l, this.l.random, blockposition);
