    ...
    static void b() {
        ...
        BlockDispenser.REGISTRY.a(Items.BOAT, new DispenseBehaviorItem() {
            ...
            public ItemStack b(ISourceBlock isourceblock, ItemStack itemstack) {
                ...
                if (Material.WATER.equals(material)) {
                    ...
                    if (!Material.AIR.equals(material) || !Material.WATER.equals(world.getType(blockposition.getX(), blockposition.getY() - 1, blockposition.getZ()).getBlock().getMaterial())) {
        ...
        BlockDispenser.REGISTRY.a(Item.getItemOf(Blocks.TNT), new DispenseBehaviorItem() {
            protected ItemStack b(ISourceBlock isourceblock, ItemStack itemstack) {
                ...
                org.bukkit.block.Block block = world.getWorld().getBlockAt(isourceblock.getBlockPosition().getX(), isourceblock.getBlockPosition().getY(), isourceblock.getBlockPosition().getZ());
                CraftItemStack craftItem = CraftItemStack.asCraftMirror(itemstack.cloneAndSubtract(1));
                ...
                EntityTNTPrimed entity = new EntityTNTPrimed(block.getLocation(), world, event.getVelocity().getX(), event.getVelocity().getY(), event.getVelocity().getZ(), null); // PaperSpigot
                world.addEntity(entity);
                world.makeSound(entity, "game.tnt.primed", 1.0F, 1.0F);
                return itemstack;
            }
        });
