...
public class EntityChicken extends EntityAnimal {
    ...
    public void m() {
        ...
        if (!this.isBaby() && !this.isChickenJockey() && --this.bs <= 0) {
    ...
    public void al() {
        super.al();
        this.passenger.setPosition(this.locX + (0.1 * MathHelper.sin(this.aI * 3.1415927F / 180.0F)), this.locY + (this.length * 0.5F) + this.passenger.am() + 0.0, this.locZ - (0.1 * MathHelper.cos(this.aI * 3.1415927F / 180.0F)));
