...
public class EntityEnderman extends EntityMonster {
    ...
    private boolean c(EntityHuman entityhuman) {
        ...
        if (itemstack != null && itemstack.getItem() == Item.getItemOf(Blocks.PUMPKIN)) {
            ...
            Vec3D vec3d1 = new Vec3D(this.locX - entityhuman.locX, (this.locY + (double) this.getHeadHeight()) - (entityhuman.locY + (double) entityhuman.getHeadHeight()), this.locZ - entityhuman.locZ);
            double d0 = vec3d1.b();
    ...
    protected void E() {
        ...
        if (this.world.w()) {
            ...
            if (f > 0.5F && this.world.i(MathHelper.floor(locX), MathHelper.floor(locY), MathHelper.floor(locZ)) && this.random.nextFloat() * 30.0F < (f - 0.4F) * 2.0F) {
    ...
    protected boolean b(Entity entity) {
    	Vec3D vec3d = new Vec3D(this.locX - entity.locX, this.locY + (double) this.getHeadHeight() - entity.locY + (double) entity.getHeadHeight(), this.locZ - entity.locZ);
        vec3d = vec3d.a();
        double d0 = 16.0D;
    ...
    protected boolean k(double d0, double d1, double d2) {
        ...
        if (this.world.isLoaded(x,y,z)) {
            boolean flag1 = false;

            while (!flag1 && y > 0) {
                Block block = this.world.getType(x,y-1,z).getBlock();
        ...
        if (!flag) {
            ...
            for (int i = 0; i < short0; ++i) {
                ...
                this.world.addParticle(EnumParticle.PORTAL, d7, d8, d9, f, f1, f2, EnumParticle.EMPTY_ARRAY);
            }
        ...
        if (this.isInvulnerable(damagesource)) {
            ...
            if (damagesource.getEntity() == null || !(damagesource.getEntity() instanceof EntityEndermite)) {
                ...
                if (damagesource instanceof EntityDamageSource && damagesource.getEntity() instanceof EntityHuman) {
                    if (((EntityPlayer) damagesource.getEntity()).playerInteractManager.isCreative()) {
                        this.a(false);
                    } else {
                        this.bm = true;
                    }
    ...
    static class PathfinderGoalEndermanPickupBlock extends PathfinderGoal {
        ...
        public void e() {
            ...
            if (EntityEnderman.c.contains(block)) {
                ...
                if (!org.bukkit.craftbukkit.event.CraftEventFactory.callEntityChangeBlockEvent(this.enderman, this.enderman.world.getWorld().getBlockAt(i, j, k), org.bukkit.Material.AIR).isCancelled()) {
                    this.enderman.setCarried(iblockdata);
                    world.setTypeUpdate(new BlockPosition(i, j, k), Blocks.AIR.getBlockData());
                }
                // CraftBukkit end
            }
    ...
    static class PathfinderGoalEndermanPlaceBlock extends PathfinderGoal {
        ...
        public void e() {
            ...
            Block block = world.getType(i, j, k).getBlock();
 
            if (this.a(world, blockposition, this.a.getCarried().getBlock(), block, world.getType(i, j - 1, k).getBlock())) {
                // CraftBukkit start - Place event
                if (!org.bukkit.craftbukkit.event.CraftEventFactory.callEntityChangeBlockEvent(this.a,i,j,k, this.a.getCarried().getBlock(), this.a.getCarried().getBlock().toLegacyData(this.a.getCarried())).isCancelled()) {
                world.setTypeAndData(new BlockPosition(i, j, k), this.a.getCarried(), 3);
    ...
    static class PathfinderGoalPlayerWhoLookedAtTarget extends PathfinderGoalNearestAttackableTarget {
        ...
        public boolean a() {
            double d0 = this.f();
            List list = this.e.world.a(EntityHuman.class, this.e.boundingBox.grow(d0, 4.0D, d0), this.c);
        ...
        public void d() {
            this.g = null;
            this.j.a(false);
            this.j.getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).c(EntityEnderman.b);
            super.d();
        }
        ...
        public void e() {
            if (this.g != null) {
                if (--this.h <= 0) {
                    ...
                    this.j.a(true);
                    j.getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).b(EntityEnderman.b);
                }
            } else {
                if (this.d != null) {
