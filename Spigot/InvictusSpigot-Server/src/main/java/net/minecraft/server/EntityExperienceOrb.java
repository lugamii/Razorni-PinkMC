...
public class EntityExperienceOrb extends Entity {
    ...
    public void t_() {
        ...
        if (this.world.getType(MathHelper.floor(locX), MathHelper.floor(locY), MathHelper.floor(locZ)).getBlock().getMaterial() == Material.LAVA) {
        ...
        if (this.onGround) {
            f = this.world.getType(MathHelper.floor(this.locX), MathHelper.floor(this.getBoundingBox().b) - 1, MathHelper.floor(this.locZ)).getBlock().frictionFactor * 0.98F;
        }
