...
public abstract class EntityFireball extends Entity {
    ...
    public void t_() {
        if ((this.shooter != null && this.shooter.dead || !this.world.isLoaded(MathHelper.floor(this.locX), MathHelper.floor(this.locY), MathHelper.floor(this.locZ)))) {
            this.die();
        } else {
            super.t_();
            this.setOnFire(1);
            if (this.i) {
                if (this.world.getType(this.e, this.f, this.g).getBlock() == this.h) {
                    ++this.ar;
                    if (this.ar == 600) {
                        this.die();
                    }
            ...
            if (this.V()) {
                for (int j = 0; j < 4; ++j) {
                    float f3 = 0.25F;
                    this.world.addParticle(EnumParticle.WATER_BUBBLE, this.locX - this.motX * f3, this.locY - this.motY * (double) f3, this.locZ - this.motZ * (double) f3, this.motX, this.motY, this.motZ, EnumParticle.EMPTY_ARRAY);
                }
            ...
            this.motY *= f2;
            this.motZ *= f2;
            this.world.addParticle(EnumParticle.SMOKE_NORMAL, this.locX, this.locY + 0.5D, this.locZ, 0.0D, 0.0D, 0.0D, EnumParticle.EMPTY_ARRAY);
            this.setPosition(this.locX, this.locY, this.locZ);
        }
    }
