...
public class EntityHorse extends EntityAnimal implements IInventoryListener {
    ...
    private static final Predicate<Entity> bs = entity -> entity instanceof EntityHorse && ((EntityHorse) entity).cA();
    ...
    public boolean cD() {
        this.world.getBiome(MathHelper.floor(this.locX), 0, MathHelper.floor(this.locZ));
        return true;
    }
    ...
    public void e(float f, float f1) {
        ...
        if (i > 0) {
            ...
            if (InvictusConfig.footstepSounds) {
                Block block = this.world.getType(MathHelper.floor(this.locX), MathHelper.floor(this.locY - 0.2D - (double) this.lastYaw), MathHelper.floor(this.locZ)).getBlock();
    ...
    protected EntityHorse a(Entity entity, double d0) {
        ...
        for (Entity entity2 : world.a(entity, entity.boundingBox.a(d0, d0, d0), EntityHorse.bs)) {
    ...
    protected void a(BlockPosition blockposition, Block block) {
        ...
        if (this.world.getType(blockposition.getX(), blockposition.getY() + 1, blockposition.getZ()).getBlock() == Blocks.SNOW_LAYER) {
    ...
    public void g(EntityHuman entityhuman) {
        if ((this.passenger == null || this.passenger == entityhuman) && this.isTame()) {
            this.inventoryChest.a(this.getName());
    ...
    public void m() {
        ...
        if (!this.cy() && this.passenger == null && this.random.nextInt(300) == 0 && this.world.getType(MathHelper.floor(this.locX), MathHelper.floor(this.locY) - 1, MathHelper.floor(this.locZ)).getBlock() == Blocks.GRASS) {
            this.r(true);
        }
    ...
    public boolean h(EntityHuman entityhuman) {
        this.setOwnerUUID(FastUUID.toString(entityhuman.getUniqueID()));
        this.setTame(true);
        return true;
    }
