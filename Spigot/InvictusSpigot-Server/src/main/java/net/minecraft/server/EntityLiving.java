...
import eu.vortexdev.invictusspigot.util.CraftPotionUtil;
...
public abstract class EntityLiving extends Entity {
    ...
    public final Map<Integer, MobEffect> effects = new ConcurrentHashMap<>();
    ...
    public void K() {
        ...
        if (this.isAlive()) {
            if (noDamageTicks <= maxNoDamageTicks / 2.0F && inBlock()) { // Vortex - Don't check inBlock if entity is undamageable
                this.damageEntity(DamageSource.STUCK, 1.0F);
            } else if (InvictusConfig.borderDamageCheck && flag && !world.getWorldBorder().a(boundingBox)) {
                double d0 = world.getWorldBorder().a(this) + world.getWorldBorder().getDamageBuffer();
                if (d0 < 0.0D)
                    damageEntity(DamageSource.STUCK, Math.max(1, MathHelper.floor(-d0 * world.getWorldBorder().getDamageAmount())));
            }
        }
        ...
        if (this.isAlive() && inWater && this.a(Material.WATER)) { // Vortex - inWater
            ...
            if (this.au() && this.vehicle instanceof EntityLiving) {
                this.mount(null);
            }
    ...
    public int getExpReward() {
        ...
        if ((this.lastDamageByPlayerTime > 0 || this.alwaysGivesExp()) && this.ba() && this.world.getGameRules().getBoolean("doMobLoot")) {
            return exp;
        } else {
            return 0;
        }
        ...
        if (this.deathTicks >= 20 && !this.dead) { // CraftBukkit - (this.deathTicks == 20) -> (this.deathTicks >= 20 &&
            ...
            for (i = 0; i < 20; ++i)
                this.world.addParticle(EnumParticle.EXPLOSION_NORMAL,
                        ...
                        random.nextGaussian() * 0.02D, EnumParticle.EMPTY_ARRAY);
        }
    ...
    public void b(NBTTagCompound nbttagcompound) {
        ...
        for (ItemStack itemstack : getEquipment()) {
            if (itemstack != null) {
                Multimap<String, AttributeModifier> tag = itemstack.B();
                this.c.a(tag);
                this.c.b(tag);
            }
        }
    ...
    public void bi() {
        ...
        while (iterator.hasNext()) {
            ...
            if (!mobeffect.tick(this)) {
                PotionEffectExpireEvent event = new PotionEffectExpireEvent((LivingEntity) getBukkitEntity(), new PotionEffect(PotionEffectType.getById(mobeffect.getEffectId()), mobeffect.getDuration(), mobeffect.getAmplifier(), mobeffect.isAmbient()));
                this.world.getServer().getPluginManager().callEvent(event);
                if (event.isCancelled()) {
                    mobeffect.a(new MobEffect(mobeffect.getEffectId(), event.getDuration(), mobeffect.getAmplifier(), mobeffect.isAmbient(), mobeffect.isShowParticles()));
                    continue;
                }
                iterator.remove();
                b(mobeffect);
        ...
        if (i > 0) {
            ...
            if (flag1) {
                this.world.addParticle(flag ? EnumParticle.SPELL_MOB_AMBIENT : EnumParticle.SPELL_MOB,
                        ...
                        this.locZ + (this.random.nextDouble() - 0.5D) * this.width, (i >> 16 & 255) / 255.0D,
                        (i >> 8 & 255) / 255.0D, (i & 255) / 255.0D, EnumParticle.EMPTY_ARRAY);
            }
        }
    ...
    public void removeAllEffects() {
        ...
        while (iterator.hasNext()) {
            Integer integer = iterator.next();
            MobEffect mobeffect = this.effects.get(integer);
            PotionEffectRemoveEvent event = new PotionEffectRemoveEvent((LivingEntity) getBukkitEntity(), new PotionEffect(PotionEffectType.getById(mobeffect.getEffectId()), mobeffect.getDuration(), mobeffect.getAmplifier(), mobeffect.isAmbient()));
            this.world.getServer().getPluginManager().callEvent(event);
            iterator.remove();
            b(mobeffect);
        }
    ...
    public void addEffect(MobEffect mobeffect, PotionEffectAddEvent.EffectCause cause) {
        if (d(mobeffect)) {
            ...
            PotionEffect effect = CraftPotionUtil.toBukkit(mobeffect);
            PluginManager manager = this.world.getServer().getPluginManager();
            MobEffect current = this.effects.get(mobeffect.getEffectId());
            if (current != null) {
                PotionEffectExtendEvent event = new PotionEffectExtendEvent(entity, effect, CraftPotionUtil.toBukkit(current), cause);
                manager.callEvent(event);
                if (event.isCancelled())
                    return;
                manager.callEvent(new PotionEffectRemoveEvent(entity, effect));
                current.a(mobeffect);
                a(current, true);
            } else {
                PotionEffectAddEvent event = new PotionEffectAddEvent(entity, effect, cause);
                manager.callEvent(event);
                if (event.isCancelled())
                    return;
                this.effects.put(mobeffect.getEffectId(), mobeffect);
    ...
    public void removeEffect(int i) {
        ...
        if (mobeffect != null) {
            ...
            PotionEffectRemoveEvent event = new PotionEffectRemoveEvent((LivingEntity) getBukkitEntity(), effect);
            this.world.getServer().getPluginManager().callEvent(event);
            b(mobeffect);
        }
    }
    ...
    public void setHealth(float f) {
        ...
        if (this instanceof EntityPlayer) {
            ...
            if (player.getHealth() != 0.0D || !InvictusConfig.autoRespawn)
    ...
    public boolean damageEntity(DamageSource damagesource, float f) {
        ...
        if (getHealth() <= 0.0F || damagesource.o() && hasEffect(MobEffectList.FIRE_RESISTANCE))
            return false;
        this.aB = 1.5F;
        int maxNoDamageTicks = this.maxNoDamageTicks;
        if(this instanceof EntityPlayer) {
            maxNoDamageTicks = ((EntityPlayer)this).getKnockbackProfile().getSettingValue("hitDelay");
        }
        boolean flag = true;
        if (!damagesource.translationIndex.equals("arrow") && this.noDamageTicks > maxNoDamageTicks / 2) {
    ...
    public void b(ItemStack itemstack) {
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            Vec3D vec3d1 = new Vec3D((this.random.nextFloat() - 0.5D) * 0.3D, -random.nextFloat() * 0.6D - 0.3D, 0.6D);
    ...
    public boolean k_() {
        if (!(this instanceof EntityHuman) || !((EntityHuman) this).isSpectator()) {
            Block block = this.world.getType(MathHelper.floor(this.locX), MathHelper.floor(this.boundingBox.b),
                    MathHelper.floor(this.locZ)).getBlock();
    ...
    public void e(float f, float f1) {
        ...
        if (i > 0) {
            // CraftBukkit start
            if (!damageEntity(DamageSource.FALL, (float) (i * InvictusConfig.fallDamageBoost))) {
                return;
            }
            // CraftBukkit end
            ...
            if (InvictusConfig.footstepSounds) {
                Block block = this.world.getType(MathHelper.floor(this.locX), MathHelper.floor(this.locY - 0.20000000298023224D), MathHelper.floor(this.locZ)).getBlock();
    ...
    protected boolean d(final DamageSource damagesource, float f) { // void -> boolean, add final
        if (!this.isInvulnerable(damagesource)) {
            ...
            Function<Double, Double> blocking = f13 -> {
                if (human) {
                    if (!damagesource.ignoresArmor() && ((EntityHuman) EntityLiving.this).isBlocking() && f13 > 0.0F) {
            ...
            Function<Double, Double> armor = f17 -> -(f17 - EntityLiving.this.applyArmorModifier(damagesource, f17.floatValue()));
            ...
            Function<Double, Double> magic = f15 -> -(f15 - EntityLiving.this.applyMagicModifier(damagesource, f15.floatValue()));
            float magicModifier = magic.apply((double) f).floatValue();
            f += magicModifier;

            Function<Double, Double> absorption = f16 -> -(Math.max(f16 - Math.max(f16 - EntityLiving.this.getAbsorptionHearts(), 0.0F), 0.0F));
            ...
            if (damagesource == DamageSource.ANVIL || damagesource == DamageSource.FALLING_BLOCK) {
                ItemStack helmet = getEquipment(4);
                if(helmet != null)
                    helmet.damage((int) (event.getDamage() * 4.0F + this.random.nextFloat() * event.getDamage() * 2.0F), this);
            }
            ...
            for (int j = -b0; j < b0; ++j) {
                if (i != 0 || j != 0) {
                    ...
                    if (this.world.a(axisalignedbb).isEmpty()) {
                        ...
                        if (World.a(this.world, k, (int) this.locY - 1, l) || this.world.getType(k, (int) this.locY - 1, l).getBlock().getMaterial() == Material.WATER) {
    ...
    protected void bF() {
        ...
        if (this.isSprinting()) {
            ...
            this.motX -= MathHelper.sin(f) * 0.2;
            this.motZ += MathHelper.cos(f) * 0.2;
        }
    ...
    public void g(float f, float f1) {
        ...
        if (this.bM()) {
            ...
            if (this.V() && (!(this instanceof EntityHuman) || !((EntityHuman) this).abilities.isFlying)) {
                ...
                if (this.onGround) {
                    f5 = this.world.getType(MathHelper.floor(this.locX), MathHelper.floor(this.boundingBox.b) - 1, MathHelper.floor(this.locZ)).getBlock().frictionFactor * 0.91F;
                }
    ...
    public void t_() {
        ...
        for (int j = 0; j < 5; ++j) {
            ...
            if (!ItemStack.fastMatches(itemstack1, itemstack)) { // Spigot
                ((WorldServer) this.world).getTracker().a(this,
                        new PacketPlayOutEntityEquipment(this.getId(), j, itemstack1, InvictusConfig.patchArmorNametags));
                if (itemstack != null) {
    ...
    public void m() {
        ...
        if (InvictusConfig.entityCollisions && ticksLived % InvictusConfig.collisionsDelay == 0 && getBukkitEntity().getLocation().getChunk().getEntityCount() < 50) { // Vortex - optimized collisions
            this.bL();
        }
    }
    ...
    protected void bL() {
        if (this.ad()) { // Spigot: Add this.ad() condition
            List<Entity> list = this.world.a(this, this.boundingBox.grow(0.20000000298023224D, 0.0D, 0.20000000298023224D), Predicates.and(IEntitySelector.d, object -> object.ae()));
            ...
            for (Entity entity : list) {
                ...
                if (entity instanceof EntityLiving && !(this instanceof EntityHuman) && ticksLived % 2 == 0) {
                    continue;
                }
                // CraftBukkit end
    ...
    public ScoreboardTeamBase getScoreboardTeam() {
        return this.world.getScoreboard().getPlayerTeam(FastUUID.toString(this.getUniqueID()));
    }
    ...
    public boolean a(ScoreboardTeamBase scoreboardteambase) {
        ScoreboardTeamBase team = getScoreboardTeam();
        return team != null && team.isAlly(scoreboardteambase);
    }
