...
public class EntityMinecartFurnace extends EntityMinecartAbstract {
    ...
    public void t_() {
        ...
        if (this.j() && this.random.nextInt(4) == 0) {
            this.world.addParticle(EnumParticle.SMOKE_LARGE, this.locX, this.locY + 0.8D, this.locZ, 0.0D, 0.0D, 0.0D, EnumParticle.EMPTY_ARRAY);
        }
    ...
    protected void a(final int x, final int y, final int z, IBlockData iblockdata) {
        super.a(x,y,z, iblockdata);
