...
public class EntitySilverfish extends EntityMonster {
    ...
    public float a(BlockPosition blockposition) {
        return this.world.getType(blockposition.getX(), blockposition.getY() - 1, blockposition.getZ()).getBlock() == Blocks.STONE ? 10.0F : super.a(blockposition);
    }
        ...
        public boolean a() {
            if (this.silverfish.getGoalTarget() != null) {
                ...
                if (random.nextInt(10) == 0) {
                    ...
                    IBlockData iblockdata = this.silverfish.world.getType(MathHelper.floor(this.silverfish.locX + b.getAdjacentX()), MathHelper.floor(this.silverfish.locY + 0.5D + b.getAdjacentY()), MathHelper.floor(this.silverfish.locZ + b.getAdjacentZ()));
