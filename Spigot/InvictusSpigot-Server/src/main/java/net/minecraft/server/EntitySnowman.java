...
public class EntitySnowman extends EntityGolem implements IRangedEntity {
    ...
    public void m() {
        ...
        if (this.world.getBiome(i, 0, k).aV(i, j, k) > 1.0F) {
        ...
        for (int l = 0; l < 4; ++l) {
            ...
            if (this.world.getType(blockposition).getBlock().getMaterial() == Material.AIR && this.world.getBiome(i, 0, k).a(blockposition) < 0.8F && Blocks.SNOW_LAYER.canPlace(this.world, blockposition)) {
                // CraftBukkit start
