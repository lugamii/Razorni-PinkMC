...
public class EntityVillager extends EntityAgeable implements IMerchant, NPC {
    ...
    protected void E() {
        if (--this.profession <= 0) {
            ...
            if (this.village == null) {
                ...
                this.a(blockposition1, (int) ((float) this.village.b()));
                if (this.bz) {
                    this.bz = false;
                    this.village.b(5);
                }
    ...
    private void cw() {
        ...
        if (j >= 0 && j < aentityvillager_imerchantrecipeoption1.length) {
            ...
            for (IMerchantRecipeOption entityvillager_imerchantrecipeoption : aentityvillager_imerchantrecipeoption1[j]) {
    ...
    public void onLightningStrike(EntityLightning entitylightning) {
        if (!this.dead) {
            ...
            entitywitch.prepare(this.world.E(MathHelper.floor(entitywitch.locX), MathHelper.floor(entitywitch.locY), MathHelper.floor(entitywitch.locZ)), null);
    ...
    static class MerchantRecipeOptionEnchant implements EntityVillager.IMerchantRecipeOption {
        ...
        public void a(MerchantRecipeList merchantrecipelist, Random random) {
            ...
            EnchantmentManager.a(random, itemstack1, 5 + random.nextInt(15));
