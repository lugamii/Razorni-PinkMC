...
public class EntityWolf extends EntityTameableAnimal {
    ...
    public void m() {
        super.m();
        if (this.bq && !this.br && !this.cf() && this.onGround) {
            this.br = true;
            this.bs = 0.0F;
            this.bt = 0.0F;
        ...
        if (this.U()) {
            ...
            if (this.bs > 0.4F) {
                ...
                for (int j = 0; j < i; ++j) {
                    ...
                    this.world.addParticle(EnumParticle.WATER_SPLASH, this.locX + f1, (f + 0.8F), this.locZ + f2, this.motX, this.motY, this.motZ, EnumParticle.EMPTY_ARRAY);
                }
            }
        }
    ...
    public boolean a(EntityHuman entityhuman) {
        ...
        if (this.isTamed()) {
            ...
            if (this.e((EntityLiving) entityhuman) && !this.d(itemstack)) {
