    ...
    public boolean interactWith(ItemStack itemstack, EntityHuman entityhuman, World world, BlockPosition blockposition, EnumDirection enumdirection, float f, float f1, float f2) {
        if (enumdirection != EnumDirection.UP) {
            ...
            if (entityhuman.a(blockposition, enumdirection, itemstack) && entityhuman.a(blockposition1, enumdirection, itemstack)) {
                ...
                if (flag2 && flag3 && World.a(world, blockposition.getX(), blockposition.getY() - 1, blockposition.getZ()) && World.a(world, blockposition1.getX(), blockposition1.getY() - 1, blockposition1.getZ())) {
                    IBlockData iblockdata1 = Blocks.BED.getBlockData().set(BlockBed.OCCUPIED, Boolean.FALSE).set(BlockBed.FACING, enumdirection1).set(BlockBed.PART, BlockBed.EnumBedPart.FOOT);
