    ...
    private static final IDispenseBehavior a = new DispenseBehaviorItem() {
        ...
        public ItemStack b(ISourceBlock isourceblock, ItemStack itemstack) {
            ...
            if (BlockMinecartTrackAbstract.d(iblockdata)) {
                ...
                if (iblockdata.getBlock().getMaterial() != Material.AIR || !BlockMinecartTrackAbstract.d(world.getType(blockposition.getX(), blockposition.getY() - 1, blockposition.getZ()))) {
                    return this.b.a(isourceblock, itemstack);
                }

                IBlockData iblockdata1 = world.getType(blockposition.getX(), blockposition.getY() - 1, blockposition.getZ());
