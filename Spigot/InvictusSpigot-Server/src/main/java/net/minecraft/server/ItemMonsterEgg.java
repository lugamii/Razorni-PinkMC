        ...
        if (!EntityTypes.eggInfo.containsKey(i)) {
            ...
            for (int j = 0; j < 1; ++j) {
                ...
                if (entity instanceof EntityLiving) {
                    ...
                    entityinsentient.prepare(world.E(MathHelper.floor(entityinsentient.locX), MathHelper.floor(entityinsentient.locY), MathHelper.floor(entityinsentient.locZ)), null);
