...
public class NameReferencingFileConverter {
    ...
    public static boolean c(final MinecraftServer minecraftserver) {
        ...
        if (NameReferencingFileConverter.c.exists() && NameReferencingFileConverter.c.isFile()) {
            ...
            try {
                a(minecraftserver, Files.readLines(NameReferencingFileConverter.c, Charsets.UTF_8), new ProfileLookupCallback() {
                    public void onProfileLookupSucceeded(GameProfile gameprofile) {
                        minecraftserver.getUserCache().a(gameprofile);
    ...
    public static boolean d(final MinecraftServer minecraftserver) {
        ...
        if (NameReferencingFileConverter.d.exists() && NameReferencingFileConverter.d.isFile()) {
            ...
            try {
                a(minecraftserver, Files.readLines(NameReferencingFileConverter.d, Charsets.UTF_8), new ProfileLookupCallback() {
                    public void onProfileLookupSucceeded(GameProfile gameprofile) {
                        minecraftserver.getUserCache().a(gameprofile);
    ...
    public static String a(String s) {
        if (!UtilColor.b(s) && s.length() <= 16) {
            ...
            } else if (minecraftserver.getOnlineMode()) {
                final ArrayList<GameProfile> arraylist = Lists.newArrayList();

                a(minecraftserver, Lists.newArrayList(s), new ProfileLookupCallback() {
                    public void onProfileLookupSucceeded(GameProfile gameprofile) {
                        minecraftserver.getUserCache().a(gameprofile);
    ...
    public static boolean a(final DedicatedServer dedicatedserver, PropertyManager propertymanager) {
        ...
        if (file.exists() && file.isDirectory()) {
            ...
            try {
                ...
                a(dedicatedserver, Lists.newArrayList(astring), new ProfileLookupCallback() {
                    public void onProfileLookupSucceeded(GameProfile gameprofile) {
