...
public abstract class NavigationAbstract {
    ...
    public PathEntity a(BlockPosition blockposition) {
        if (!this.b()) {
            ...
            return j.a(new ChunkCache(this.c, blockposition1.a(-i, -i, -i), blockposition1.a(i, i, i), 0), this.b, blockposition, f);
        }
    }

    public boolean a(double d0, double d1, double d2, double d3) {
        return this.a(a(MathHelper.floor(d0), ((int) d1), MathHelper.floor(d2)), d3);
    }
    ...
    public PathEntity a(Entity entity) {
        if (!this.b()) {
            ...
            BlockPosition blockposition = new BlockPosition(b.getX(), b.getY() + 1, b.getZ());
            int i = (int) (f + 16.0F);

            return j.a(new ChunkCache(this.c, blockposition.a(-i, -i, -i), blockposition.a(i, i, i), 0), this.b, entity, f);
        }
    }
