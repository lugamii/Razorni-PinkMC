...
public class PacketPlayOutMultiBlockChange implements Packet<PacketListenerPlayOut> {
	...
	public PacketPlayOutMultiBlockChange(int var1, short[] var2, Chunk var3) {
		...
		this.b = new MultiBlockChangeInfo[var1];

		for (int var4 = 0; var4 < this.b.length; ++var4) {
			this.b[var4] = new MultiBlockChangeInfo(var2[var4], var3);
		}
	...
	public void a(PacketDataSerializer var1) throws IOException {
		...
		this.b = new MultiBlockChangeInfo[var1.e()];

		for (int var2 = 0; var2 < this.b.length; ++var2) {
			this.b[var2] = new MultiBlockChangeInfo(var1.readShort(), Block.d.a(var1.e()));
		}
	...
	public void b(PacketDataSerializer var1) throws IOException {
		...
		for (MultiBlockChangeInfo var5 : b) {
