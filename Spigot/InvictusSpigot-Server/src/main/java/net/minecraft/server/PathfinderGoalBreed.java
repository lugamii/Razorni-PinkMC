    ...
    private void g() {
        ...
        if (entityageable != null) {
            ...
            for (int i = 0; i < 7; ++i) {
                ...
                double d3 = random.nextDouble() * this.d.width * 2.0D - (double) this.d.width;
                double d4 = 0.5D + random.nextDouble() * (double) this.d.length;
                double d5 = random.nextDouble() * this.d.width * 2.0D - (double) this.d.width;

                this.a.addParticle(EnumParticle.HEART, this.d.locX + d3, this.d.locY + d4, this.d.locZ + d5, d0, d1, d2, EnumParticle.EMPTY_ARRAY);
            }
