...
public class PathfinderGoalEatTile extends PathfinderGoal {
    ...
    private static final Predicate<IBlockData> b = BlockStatePredicate.a(Blocks.TALLGRASS).a(BlockLongGrass.TYPE, enumTallGrassType -> Objects.equals(enumTallGrassType, BlockLongGrass.EnumTallGrassType.GRASS));
    ...
    public boolean a() {
        if (this.c.bc().nextInt(this.c.isBaby() ? 50 : 1000) != 0) {
            ...
            return PathfinderGoalEatTile.b.apply(this.d.getType(blockposition)) || this.d.getType(blockposition.getX(), blockposition.getY() - 1, blockposition.getZ()).getBlock() == Blocks.GRASS;
        }
    }
