...
public class PathfinderNormal extends PathfinderAbstract {
    ...
    public static int a(IBlockAccess iblockaccess, Entity entity, int i, int j, int k, int l, int i1, int j1, boolean flag, boolean flag1, boolean flag2) {
        boolean flag3 = false;
        int x = MathHelper.floor(entity.locX), y = MathHelper.floor(entity.locY), z = MathHelper.floor(entity.locZ);
                ...
                for (int i2 = k; i2 < k + j1; ++i2) {
                    ...
                    if (block.getMaterial() != Material.AIR) {
                        ...
                        if (block instanceof BlockMinecartTrackAbstract) { // PaperSpigot - Pathfinder optimizations
                            if (!(iblockaccess.getType(x, y, z).getBlock() instanceof BlockMinecartTrackAbstract) && !(iblockaccess.getType(x, y - 1, z).getBlock() instanceof BlockMinecartTrackAbstract)) { // PaperSpigot - Pathfinder optimizations
                                return -3;
                            }
