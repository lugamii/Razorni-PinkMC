...
public class PortalTravelAgent {
        ...
        for (int l = -2; l <= 2; ++l) {
            for (int i1 = -2; i1 <= 2; ++i1) {
                for (int j1 = -1; j1 < 3; ++j1) {
                    ...
                    if (this.a.getType(k1, l1, i2).getBlock() != (flag ? Blocks.OBSIDIAN : Blocks.AIR)) {
                        return null;
                    }
                }
            }
    ...
    public BlockPosition findPortal(double x, double y, double z, int searchRadius) { // Paper - actually use search radius
        ...
        if (this.c.contains(k)) {
            ChunkCoordinatesPortal portaltravelagent_chunkcoordinatesportal = this.c.getEntry(k);
                            ...
                            for (k3 = 0; k3 < 3; ++k3) {
                                for (l3 = 0; l3 < 4; ++l3) {
                                    for (i4 = -1; i4 < 4; ++i4) {
                                        ...
                                        if (i4 < 0 && !this.a.getType(j4, k4, l4).getBlock().getMaterial().isBuildable() || i4 >= 0 && !this.a.isEmpty(j4, k4, l4)) {
                                            continue label271;
                                        }
                                    }
                                }
                            ...
                            for (l2 = l1; l2 < l1 + 2; ++l2) {
                                ...
                                for (k3 = 0; k3 < 4; ++k3) {
                                    for (l3 = -1; l3 < 4; ++l3) {
                                        ...
                                        j4 = k2 + l3;
                                        k4 = j2 + (k3 - 1) * j3;
                                        if (l3 < 0 && !this.a.getType(i4, j4, k4).getBlock().getMaterial().isBuildable() || l3 >= 0 && !this.a.isEmpty(i4, j4, k4)) {
                                            continue label219;
                                        }
                                    }
                                }
        ...
        for (l2 = 0; l2 < 4; ++l2) {
            ...
            for (i3 = 0; i3 < 4; ++i3) {
                for (j3 = -1; j3 < 4; ++j3) {
                    ...
                    l3 = j5 + j3;
                    i4 = j2 + (i3 - 1) * l5;
                    this.a.applyPhysics(k3, l3, i4, this.a.getType(k3, l3, i4).getBlock());
                }
            }
        }
    ...
    public void a(long i) {
        if (i % 100L == 0L) {
            ...
            while (iterator.hasNext()) {
                ...
                ChunkCoordinatesPortal portaltravelagent_chunkcoordinatesportal = this.c.getEntry(olong);
