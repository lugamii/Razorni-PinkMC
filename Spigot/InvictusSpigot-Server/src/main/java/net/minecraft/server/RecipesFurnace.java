...
public class RecipesFurnace {
    ...
    public final Map<ItemStack, ItemStack> customRecipes = Maps.newHashMap(); // CraftBukkit - add field
    ...
    public RecipesFurnace() { // PAIL: Public
        ...
        for (ItemFish.EnumFish itemfish_enumfish : ItemFish.EnumFish.values()) {
