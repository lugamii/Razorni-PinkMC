    ...
    private boolean b() {
        ...
        for (EntityHuman entityhuman : list) {
            if (!entityhuman.isSpectator()) {
                this.f = this.a.ae().getClosestVillage(MathHelper.floor(entityhuman.locX), MathHelper.floor(entityhuman.locY), MathHelper.floor(entityhuman.locZ), 1);
    ...
    private boolean c() {
        ...
        if (vec3d == null) {
            ...
            try {
                ...
                entityzombie.prepare(this.a.E(MathHelper.floor(entityzombie.locX), MathHelper.floor(entityzombie.locY), MathHelper.floor(entityzombie.locZ)), null);
