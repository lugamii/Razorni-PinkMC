...
public class WorldChunkManager {
    ...
    public WorldChunkManager(long i, WorldType worldtype, String s, World world) {
        this();
        GenLayer[] agenlayer = GenLayer.a(i, worldtype, s, world);
    ...
    public WorldChunkManager(World world) {
        this(world.getSeed(), world.getWorldData().getType(), world.getWorldData().getGeneratorOptions(), world);
    }
    ...
    public BiomeBase getBiome(BlockPosition blockposition) {
        return this.getBiome(blockposition, null);
    }
