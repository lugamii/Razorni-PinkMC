...
public class WorldGenCaves extends WorldGenBase {
                                ...
                                if (d12 * d12 + d13 * d13 < 1.0D) {
                                    for (int j4 = k2; j4 > j2; --j4) {
                                        ...
                                        if (d14 > -0.7D && d12 * d12 + d14 * d14 + d13 * d13 < 1.0D) {
                                            ...
                                            IBlockData iblockdata2 = Objects.firstNonNull(chunksnapshot.a(j3, j4 + 1, i4), Blocks.AIR.getBlockData());
                                            ...
                                            if (this.a(iblockdata1, iblockdata2)) {
                                                if (j4 - 1 < 10) {
                                                    ...
                                                    if (flag3 && chunksnapshot.a(j3, j4 - 1, i4).getBlock() == Blocks.DIRT) {
                                                        chunksnapshot.a(j3, j4 - 1, i4, this.c.getBiome(j3 + j * 16, 0, i4 + k * 16).ak.getBlock().getBlockData());
                                                    }
                                                }
                                            }
                                        }
    ...
    protected boolean a(IBlockData iblockdata, IBlockData iblockdata1) {
        return iblockdata.getBlock() == Blocks.STONE || (iblockdata.getBlock() == Blocks.DIRT || (iblockdata.getBlock() == Blocks.GRASS || (iblockdata.getBlock() == Blocks.HARDENED_CLAY || (iblockdata.getBlock() == Blocks.STAINED_HARDENED_CLAY || (iblockdata.getBlock() == Blocks.SANDSTONE || (iblockdata.getBlock() == Blocks.RED_SANDSTONE || (iblockdata.getBlock() == Blocks.MYCELIUM || (iblockdata.getBlock() == Blocks.SNOW_LAYER || (iblockdata.getBlock() == Blocks.SAND || iblockdata.getBlock() == Blocks.GRAVEL) && iblockdata1.getBlock().getMaterial() != Material.WATER))))))));
    }
