        ...
        for (l1 = j; l1 <= k; ++l1) {
            for (i2 = -1; i2 <= 4; ++i2) {
                for (j2 = i1; j2 <= j1; ++j2) {
                    ...
                    if ((l1 == j || l1 == k || j2 == i1 || j2 == j1) && i2 == 0 && world.isEmpty(blockposition1) && world.isEmpty(blockposition1.getX(), blockposition1.getY() + 1, blockposition1.getZ())) {
                        ++k1;
                    }
                }
            }
            ...
            for (l1 = j; l1 <= k; ++l1) {
                for (i2 = 3; i2 >= -1; --i2) {
                    for (j2 = i1; j2 <= j1; ++j2) {
                        ...
                        } else if (blockposition1.getY() >= 0 && !world.getType(blockposition1.getX(), blockposition1.getY() - 1, blockposition1.getZ()).getBlock().getMaterial().isBuildable()) {
                            world.setAir(blockposition1);
                        ...
                        label197:
                        {
                            ...
                            if (world.isEmpty(blockposition2)) {
                                ...
                                if (i3 == 1) {
                                    ...
                                    List<StructurePieceTreasure> list = StructurePieceTreasure.a(WorldGenDungeons.c, Items.ENCHANTED_BOOK.b(random));
                                    TileEntity tileentity = world.getTileEntity(blockposition2);

                                    if (tileentity instanceof TileEntityChest) {
                                        StructurePieceTreasure.a(random, list, (IInventory) tileentity, 8);
                                    }
                                    break label197;
                                }
                            }
