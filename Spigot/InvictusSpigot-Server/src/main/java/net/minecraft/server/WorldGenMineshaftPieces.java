...
public class WorldGenMineshaftPieces {
    ...
    public static class WorldGenMineshaftCorridor extends StructurePiece {
        ...
        protected boolean a(World world, StructureBoundingBox structureboundingbox, Random random, int i, int j, int k, List<StructurePieceTreasure> list, int l) {
            ...
            if (structureboundingbox.b(blockposition) && world.getType(blockposition).getBlock().getMaterial() == Material.AIR) {
                ...
                EntityMinecartChest entityminecartchest = new EntityMinecartChest(world, (float) blockposition.getX() + 0.5F, (float) blockposition.getY() + 0.5F, (float) blockposition.getZ() + 0.5F);
            ...
            if (this.a(world, structureboundingbox)) {
                ...
                for (j = 0; j < this.d; ++j) {
                    ...
                    if (random.nextInt(100) == 0) {
                        this.a(world, structureboundingbox, random, 2, 0, k - 1, StructurePieceTreasure.a(WorldGenMineshaftPieces.a, Items.ENCHANTED_BOOK.b(random)), 3 + random.nextInt(4));
                    }

                    if (random.nextInt(100) == 0) {
                        this.a(world, structureboundingbox, random, 0, 0, k + 1, StructurePieceTreasure.a(WorldGenMineshaftPieces.a, Items.ENCHANTED_BOOK.b(random)), 3 + random.nextInt(4));
                    }
    ...
    public static class WorldGenMineshaftRoom extends StructurePiece {
        ...
        private final List<StructureBoundingBox> a = Lists.newLinkedList();
        ...
        public boolean a(World world, Random random, StructureBoundingBox structureboundingbox) {
            if (this.a(world, structureboundingbox)) {
                ...
                for (StructureBoundingBox structureboundingbox1 : this.a) {
