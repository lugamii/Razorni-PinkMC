...
public class WorldGenNether extends StructureGenerator {
    ...
    private final List<BiomeBase.BiomeMeta> d = Lists.newArrayList();
    ...
    protected boolean a(int i, int j) {
        ...
        this.b.nextInt();
        return this.b.nextInt(3) == 0 && (i == (k << 4) + 4 + this.b.nextInt(8) && j == (l << 4) + 4 + this.b.nextInt(8));
    }
    ...
    public static class WorldGenNetherStart extends StructureStart {
        ...
        public WorldGenNetherStart(World world, Random random, int i, int j) {
            ...
            List<StructurePiece> list = worldgennetherpieces_worldgennetherpiece15.e;
