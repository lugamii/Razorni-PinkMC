...
public class WorldGenPumpkin extends WorldGenerator {
    ...
    public boolean generate(World world, Random random, BlockPosition blockposition) {
        for (int i = 0; i < 64; ++i) {
            ...
            if (world.isEmpty(blockposition1) && world.getType(blockposition1.getX(), blockposition1.getY() - 1, blockposition1.getZ()).getBlock() == Blocks.GRASS && Blocks.PUMPKIN.canPlace(world, blockposition1)) {
