...
public class WorldGenRegistration {
    ...
    public static class WorldGenWitchHut extends WorldGenScatteredPiece {
    ...
    public static class WorldGenJungleTemple extends WorldGenScatteredPiece {
        ...
        private static final WorldGenJungleTemple$WorldGenJungleTemplePiece k = new WorldGenJungleTemple$WorldGenJungleTemplePiece(null);
        ...
        public boolean a(World world, Random random, StructureBoundingBox structureboundingbox) {
            if (!this.a(world, structureboundingbox, 0)) {
                ...
                if (!this.e) {
                    this.e = this.a(world, structureboundingbox, random, 8, -3, 3, StructurePieceTreasure.a(WorldGenJungleTemple.i, Items.ENCHANTED_BOOK.b(random)), 2 + random.nextInt(5));
                }
                ...
                if (!this.f) {
                    this.f = this.a(world, structureboundingbox, random, 9, -3, 10, StructurePieceTreasure.a(WorldGenJungleTemple.i, Items.ENCHANTED_BOOK.b(random)), 2 + random.nextInt(5));
                }
        ...
        static class WorldGenJungleTemple$WorldGenJungleTemplePiece extends StructurePieceBlockSelector {
            ...
            WorldGenJungleTemple$WorldGenJungleTemplePiece(SyntheticClass_1 worldgenregistration_syntheticclass_1) {
                this();
            }
        }
    }

    public static class WorldGenPyramidPiece extends WorldGenScatteredPiece {
