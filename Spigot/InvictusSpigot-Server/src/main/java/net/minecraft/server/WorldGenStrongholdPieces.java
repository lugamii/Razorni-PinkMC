...
public class WorldGenStrongholdPieces {
    ...
    public static void b() {
        ...
        for (WorldGenStrongholdPieceWeight worldgenstrongholdpieces_worldgenstrongholdpieceweight : WorldGenStrongholdPieces.b) {
    ...
    private static boolean d() {
        ...
        WorldGenStrongholdPieceWeight worldgenstrongholdpieces_worldgenstrongholdpieceweight;

        for (Iterator<WorldGenStrongholdPieceWeight> iterator = WorldGenStrongholdPieces.c.iterator(); iterator.hasNext(); WorldGenStrongholdPieces.a += worldgenstrongholdpieces_worldgenstrongholdpieceweight.b) {
            worldgenstrongholdpieces_worldgenstrongholdpieceweight = iterator.next();
    ...
    private static WorldGenStrongholdPiece a(Class<? extends WorldGenStrongholdPiece> oclass, List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
        Object object = null;
    ...
    private static WorldGenStrongholdPiece b(WorldGenStrongholdStart worldgenstrongholdpieces_worldgenstrongholdstart, List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
        if (!d()) {
            return null;
        } else {
            if (WorldGenStrongholdPieces.d != null) {
                WorldGenStrongholdPiece worldgenstrongholdpieces_worldgenstrongholdpiece = a(WorldGenStrongholdPieces.d, list, random, i, j, k, enumdirection, l);
            ...
            while (i1 < 5) {
                ...
                for (WorldGenStrongholdPieceWeight worldgenstrongholdpieces_worldgenstrongholdpieceweight : WorldGenStrongholdPieces.c) {
                    ...
                    if (j1 < 0) {
                        ...
                        WorldGenStrongholdPiece worldgenstrongholdpieces_worldgenstrongholdpiece1 = a(worldgenstrongholdpieces_worldgenstrongholdpieceweight.a, list, random, i, j, k, enumdirection, l);
    ...
    private static StructurePiece c(WorldGenStrongholdStart worldgenstrongholdpieces_worldgenstrongholdstart, List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
        if (l > 50) {
            return null;
            ...
            WorldGenStrongholdPiece worldgenstrongholdpieces_worldgenstrongholdpiece = b(worldgenstrongholdpieces_worldgenstrongholdstart, list, random, i, j, k, enumdirection, l + 1);
    ...
    static class SyntheticClass_1 {
        ...
        static {
            ...
            try {
                SyntheticClass_1.b[EnumDirection.SOUTH.ordinal()] = 2;
            } catch (NoSuchFieldError nosuchfielderror1) {
                ;
            }

            try {
                SyntheticClass_1.b[EnumDirection.WEST.ordinal()] = 3;
            } catch (NoSuchFieldError nosuchfielderror2) {
                ;
            }

            try {
                SyntheticClass_1.b[EnumDirection.EAST.ordinal()] = 4;
            } catch (NoSuchFieldError nosuchfielderror3) {
                ;
            }

            a = new int[WorldGenStrongholdPiece.WorldGenStrongholdPiece$WorldGenStrongholdDoorType.values().length];

            try {
                SyntheticClass_1.a[WorldGenStrongholdPiece.WorldGenStrongholdPiece$WorldGenStrongholdDoorType.OPENING.ordinal()] = 1;
            } catch (NoSuchFieldError nosuchfielderror4) {
                ;
            }

            try {
                SyntheticClass_1.a[WorldGenStrongholdPiece.WorldGenStrongholdPiece$WorldGenStrongholdDoorType.WOOD_DOOR.ordinal()] = 2;
            } catch (NoSuchFieldError nosuchfielderror5) {
                ;
            }

            try {
                SyntheticClass_1.a[WorldGenStrongholdPiece.WorldGenStrongholdPiece$WorldGenStrongholdDoorType.GRATES.ordinal()] = 3;
            } catch (NoSuchFieldError nosuchfielderror6) {
                ;
            }

            try {
                SyntheticClass_1.a[WorldGenStrongholdPiece.WorldGenStrongholdPiece$WorldGenStrongholdDoorType.IRON_DOOR.ordinal()] = 4;
    ...
    public static class WorldGenStrongholdPortalRoom extends WorldGenStrongholdPiece {
        ...
        public static WorldGenStrongholdPortalRoom a(List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
        ...
        public boolean a(World world, Random random, StructureBoundingBox structureboundingbox) {
            ...
            this.a(world, random, structureboundingbox, WorldGenStrongholdPiece$WorldGenStrongholdDoorType.GRATES, 4, 1, 0);
            byte b0 = 6;
            ...
            if (this.m != null) {
                switch (SyntheticClass_1.b[this.m.ordinal()]) {
                    case 2:
    ...
    public static class WorldGenStrongholdCrossing extends WorldGenStrongholdPiece {
        ...
        public static WorldGenStrongholdCrossing a(List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
    ...
    public static class WorldGenStrongholdLibrary extends WorldGenStrongholdPiece {
        ...
        private static final List<StructurePieceTreasure> a = Lists.newArrayList(new StructurePieceTreasure(Items.BOOK, 0, 1, 3, 20), new StructurePieceTreasure(Items.PAPER, 0, 2, 7, 20), new StructurePieceTreasure(Items.MAP, 0, 1, 1, 1), new StructurePieceTreasure(Items.COMPASS, 0, 1, 1, 1));
        private boolean b;
        ...
        public static WorldGenStrongholdLibrary a(List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
    ...
    public static class WorldGenStrongholdPrison extends WorldGenStrongholdPiece {
        ...
        public static WorldGenStrongholdPrison a(List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
    ...
    public static class WorldGenStrongholdRoomCrossing extends WorldGenStrongholdPiece {
        ...
        public static WorldGenStrongholdRoomCrossing a(List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
    ...
    public static class WorldGenStrongholdRightTurn extends WorldGenStrongholdLeftTurn {
    ...
    public static class WorldGenStrongholdLeftTurn extends WorldGenStrongholdPiece {
        ...
        public static WorldGenStrongholdLeftTurn a(List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
    ...
    public static class WorldGenStrongholdStairsStraight extends WorldGenStrongholdPiece {
        ...
        public static WorldGenStrongholdStairsStraight a(List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
        ...
        public boolean a(World world, Random random, StructureBoundingBox structureboundingbox) {
            if (this.a(world, structureboundingbox)) {
                ...
                this.a(world, random, structureboundingbox, WorldGenStrongholdPiece$WorldGenStrongholdDoorType.OPENING, 1, 1, 7);
    ...
    public static class WorldGenStrongholdChestCorridor extends WorldGenStrongholdPiece {
        ...
        public static WorldGenStrongholdChestCorridor a(List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
        ...
        public boolean a(World world, Random random, StructureBoundingBox structureboundingbox) {
            if (this.a(world, structureboundingbox)) {
                ...
                this.a(world, random, structureboundingbox, this.d, 1, 1, 0);
                this.a(world, random, structureboundingbox, WorldGenStrongholdPiece$WorldGenStrongholdDoorType.OPENING, 1, 1, 6);
    ...
    public static class WorldGenStrongholdStairs extends WorldGenStrongholdPiece {
        ...
        public static WorldGenStrongholdStairs a(List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
            StructureBoundingBox structureboundingbox = StructureBoundingBox.a(i, j, k, -1, -1, 0, 5, 5, 7, enumdirection);
    ...
    public static class WorldGenStrongholdStairs2 extends WorldGenStrongholdPiece {
        ...
        public static WorldGenStrongholdStairs2 a(List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
        ...
        public boolean a(World world, Random random, StructureBoundingBox structureboundingbox) {
            if (this.a(world, structureboundingbox)) {
                ...
                this.a(world, random, structureboundingbox, this.d, 1, 7, 0);
                this.a(world, random, structureboundingbox, WorldGenStrongholdPiece$WorldGenStrongholdDoorType.OPENING, 1, 1, 4);
    ...
    abstract static class WorldGenStrongholdPiece extends StructurePiece {
        ...
        protected WorldGenStrongholdPiece$WorldGenStrongholdDoorType d;
        ...
        protected void b(NBTTagCompound nbttagcompound) {
            this.d = WorldGenStrongholdPiece$WorldGenStrongholdDoorType.valueOf(nbttagcompound.getString("EntryDoor"));
        }

        protected void a(World world, Random random, StructureBoundingBox structureboundingbox, WorldGenStrongholdPiece$WorldGenStrongholdDoorType worldgenstrongholdpieces_worldgenstrongholdpiece_worldgenstrongholdpiece$worldgenstrongholddoortype, int i, int j, int k) {
            switch (SyntheticClass_1.a[worldgenstrongholdpieces_worldgenstrongholdpiece_worldgenstrongholdpiece$worldgenstrongholddoortype.ordinal()]) {
                case 1:
                default:
        ...
        protected WorldGenStrongholdPiece$WorldGenStrongholdDoorType a(Random random) {
            ...
            switch (i) {
                ...
                case 1:
                default:
                    return WorldGenStrongholdPiece$WorldGenStrongholdDoorType.OPENING;

                case 2:
                    return WorldGenStrongholdPiece$WorldGenStrongholdDoorType.WOOD_DOOR;

                case 3:
                    return WorldGenStrongholdPiece$WorldGenStrongholdDoorType.GRATES;

                case 4:
                    return WorldGenStrongholdPiece$WorldGenStrongholdDoorType.IRON_DOOR;
            }
        }

        protected StructurePiece a(WorldGenStrongholdStart worldgenstrongholdpieces_worldgenstrongholdstart, List<StructurePiece> list, Random random, int i, int j) {
            if (this.m != null) {
                switch (SyntheticClass_1.b[this.m.ordinal()]) {
                    case 1:
        ...
        protected StructurePiece b(WorldGenStrongholdStart worldgenstrongholdpieces_worldgenstrongholdstart, List<StructurePiece> list, Random random, int i, int j) {
            if (this.m != null) {
                switch (SyntheticClass_1.b[this.m.ordinal()]) {
                    case 1:
        ...
        protected StructurePiece c(WorldGenStrongholdStart worldgenstrongholdpieces_worldgenstrongholdstart, List<StructurePiece> list, Random random, int i, int j) {
            if (this.m != null) {
                switch (SyntheticClass_1.b[this.m.ordinal()]) {
                    case 1:
    ...
    static class WorldGenStrongholdPieceWeight {
        ...
        public Class<? extends WorldGenStrongholdPiece> a;
        public final int b;
        public int c;
        public int d;

        public WorldGenStrongholdPieceWeight(Class<? extends WorldGenStrongholdPiece> oclass, int i, int j) {
            this.a = oclass;
            this.b = i;
            this.d = j;
        }
