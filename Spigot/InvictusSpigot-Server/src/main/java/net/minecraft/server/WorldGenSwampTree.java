...
public class WorldGenSwampTree extends WorldGenTreeAbstract {
    ...
    private static final IBlockData b = Blocks.LEAVES.getBlockData().set(BlockLeaves1.VARIANT, BlockWood.EnumLogVariant.OAK).set(BlockLeaves1.CHECK_DECAY, Boolean.FALSE);
    ...
    public boolean generate(World world, Random random, BlockPosition blockposition) {
        ...
        for (i = random.nextInt(4) + 5; world.getType(blockposition.getX(), blockposition.getY() - 1, blockposition.getZ()).getBlock().getMaterial() == Material.WATER; blockposition = blockposition.down()) {
        }
