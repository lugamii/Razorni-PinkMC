...
public class CraftChunk implements Chunk {
	...
	public static ChunkSnapshot getEmptyChunkSnapshot(int x, int z, CraftWorld world, boolean includeBiome, boolean includeBiomeTempRain) {
		...
		if (includeBiome || includeBiomeTempRain) {
			...
			if (includeBiome) {
				...
				for (int i = 0; i < 256; i++) {
					biome[i] = world.getHandle().getBiome((x << 4) + (i & 0xF), 0, (z << 4) + (i >> 4));
				}
			}
	...
	@Override
	public eu.vortexdev.api.chunk.ChunkSnapshot takeSnapshot() {
		net.minecraft.server.Chunk handle = getHandle();
		eu.vortexdev.api.chunk.CraftChunkSnapshot snap = new eu.vortexdev.api.chunk.CraftChunkSnapshot();
	...
	@Override
	public void restoreSnapshot(eu.vortexdev.api.chunk.ChunkSnapshot snapshot) {
		eu.vortexdev.api.chunk.CraftChunkSnapshot snap = (eu.vortexdev.api.chunk.CraftChunkSnapshot) snapshot;
		net.minecraft.server.Chunk handle = getHandle();
