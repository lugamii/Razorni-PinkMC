...
public class CraftWorld implements World {
    ...
    public int getHighestBlockYAt(int x, int z) {
        ...
        return world.getHighestBlockYAt(x, z, true);
    }
    ...
    public Biome getBiome(int x, int z) {
        return CraftBlock.biomeBaseToBiome(this.world.getBiome(x, 0, z));
    }
    ...
    public double getTemperature(int x, int z) {
        return this.world.getBiome(x, 0, z).temperature;
    }

    public double getHumidity(int x, int z) {
        return this.world.getBiome(x, 0, z).humidity;
    }
    ...
    public net.minecraft.server.Entity createEntity(Location location, Class<? extends Entity> clazz) throws IllegalArgumentException {
        ...
        if (Boat.class.isAssignableFrom(clazz)) {
            ...
            IBlockData blockData = world.getType(MathHelper.floor(x), MathHelper.floor(y), MathHelper.floor(z));
    ...
    public <T extends Entity> T addEntity(net.minecraft.server.Entity entity, SpawnReason reason) throws IllegalArgumentException {
        ...
        if (entity instanceof EntityInsentient) {
            ((EntityInsentient) entity).prepare(getHandle().E(MathHelper.floor(entity.locX), MathHelper.floor(entity.locY), MathHelper.floor(entity.locZ)), null);
        }
