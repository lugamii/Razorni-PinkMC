...
public class Main {
    ...
    public static void main(String[] args) {
        OptionParser parser = new OptionParser() {
            {
                ...
                acceptsAll(asList("invictus", "invictus-settings"), "File for invictusspigot settings")
                        .withRequiredArg()
                        .ofType(File.class)
                        .defaultsTo(new File("invictus.yml"))
                        .describedAs("Yml file");
            }
        };
        ...
        if ((options == null) || (options.has("?"))) {
            ...
            try {
                useJline = !(new String(new char[]{'j', 'l', 'i', 'n', 'e', '.', 'U', 'n', 's', 'u', 'p', 'p', 'o', 'r', 't', 'e', 'd', 'T', 'e', 'r', 'm', 'i', 'n', 'a', 'l'})).equals(System.getProperty(new String(new char[]{'j', 'l', 'i', 'n', 'e', '.', 't', 'e', 'r', 'm', 'i', 'n', 'a', 'l'})));
                ...
                InvictusConfig.init((File) options.valueOf("invictus-settings"));
