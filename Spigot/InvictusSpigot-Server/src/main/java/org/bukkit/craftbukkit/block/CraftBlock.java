...
public class CraftBlock implements Block {
    ...
    public byte getLightFromSky() {
        return (byte) chunk.getHandle().getBrightness(EnumSkyBlock.SKY, this.x, this.y, this.z);
    }

    public byte getLightFromBlocks() {
        return (byte) chunk.getHandle().getBrightness(EnumSkyBlock.BLOCK, this.x, this.y, this.z);
    }
            ...
            for (int i = 0; i < count; ++i) {
                ...
                if (item != null) {
                    ...
                    if (Blocks.SKULL == block) {
                        BlockPosition position = new BlockPosition(x, y, z);
                        net.minecraft.server.ItemStack nmsStack = new net.minecraft.server.ItemStack(item, 1, block.getDropData(chunk.getHandle().getWorld(), position));
