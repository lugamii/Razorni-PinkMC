...
public class ActivationRange
{
    ...
    public static void activateEntities(World world)
    {
        ...
        for ( Entity player : (List<Entity>) (List) world.players )
        {
            ...
            maxBB = player.boundingBox.grow( maxRange, 256, maxRange );
            miscBB = player.boundingBox.grow( miscActivationRange, 256, miscActivationRange );
            animalBB = player.boundingBox.grow( animalActivationRange, 256, animalActivationRange );
            monsterBB = player.boundingBox.grow( monsterActivationRange, 256, monsterActivationRange );
            ...
            for ( int i1 = i; i1 <= j; ++i1 )
            {
                ...
                {
                    Chunk chunk = world.getChunkIfLoaded(i1, j1); // Vortex - Removed 1 useless chunk getting
                    if ( chunk != null )
                    {
    ...
    public static boolean checkIfActive(Entity entity)
    {
        ...
        Chunk chunk = entity.world.getChunkIfLoaded( MathHelper.floor( entity.locX ) >> 4, MathHelper.floor( entity.locZ ) >> 4 );
